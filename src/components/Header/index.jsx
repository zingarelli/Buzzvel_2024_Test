        ...
        <header className={styles.header}>
            <nav className={styles.nav}>
                ...
                <div className={styles.nav__contact}>
                    <Headphones />
                    <a href="#" className={styles.nav__phone}>555 818 282</a>
                    <QuoteButton />
                </div>
            </nav>
            <picture className={styles.picture}>
                <source media={`(min-width: ${tabletWidth})`} srcSet={worker_lg} />
